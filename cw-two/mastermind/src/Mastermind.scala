...
class Mastermind (showCode: Boolean) extends GameAbstractImpl(showCode) {
  ...
  //guessHistory.fill[String](maxAttempts+1)("....")
    ...
    while (successfulAttempts < maxAttempts) {
      ...
      if (isValidInput(userInput)) {
        ...
        if (results._1 == secretCode.length) {
          ...
          //println("Enter Y for another game or anything else to quit: ")
...
//        println("index: " + index)
//        println("splitStart: " + splitStart)
//        println("splitEnd: " + splitEnd)
...
//        println("secondPart: " + secondPart)
    ...
    println("userInputExclBlacks: " + userInputExclBlacks)
...
//    println("blackCount: " + blackCount)
//    println("whiteCount: " + whiteCount)
